...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Prima Donna Social — Community, courses, and connection" },
      { name: "twitter:description", content: "A private community for learning, connection, and growth." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/36b40e5f-9465-4c71-bfd5-96e3a8f58c21" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/36b40e5f-9465-4c71-bfd5-96e3a8f58c21" },
      { name: "theme-color", content: "#EC4899" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Prima Donna Social" },
